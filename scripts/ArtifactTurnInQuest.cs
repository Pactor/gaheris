	...
	public class ArtifactTurnInQuest : ArtifactQuest
	{
		...
		public static void Init()
		{
			...
			if (npcs.Length == 0)
			{
                ...
                m_scholarAlaria.CurrentRegionID = 71; m_scholarAlaria.X = 565733; m_scholarAlaria.Y = 569502; m_scholarAlaria.Z = 7255; m_scholarAlaria.Heading = 708;
			...
			if (npcs.Length == 0)
			{
                ...
                m_scholarJarron.CurrentRegionID = 70; m_scholarJarron.X = 577936; m_scholarJarron.Y = 533228; m_scholarJarron.Z = 7295; m_scholarJarron.Heading = 3731;
			...
			if (npcs.Length == 0)
			{
                ...
                m_scholarElmer.CurrentRegionID = 72; m_scholarElmer.X = 552291; m_scholarElmer.Y = 576366; m_scholarElmer.Z = 6767; m_scholarElmer.Heading = 1074;
