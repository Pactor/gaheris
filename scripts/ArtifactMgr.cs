...
namespace DOL.GS
{
	...
	public sealed class ArtifactMgr
	{
		...
		public static int LoadArtifacts()
		{
			...
			// NOTE: OpenDAoC has no GamePlayerEvent.GainedExperience, so
			// artifacts do not gain experience from the player's own kills.
			// See docs/research-notes.md -- this is the one behaviour the
			// port cannot reproduce without a core hook.
